...
crmgeo <- readRDS('data/CrimeSouthYorkshire_w_LSOAs.rds')
...
crmgeo2 <- readRDS('local/databackups/CrimeSouthYorkshire_w_LSOAs_nTotalPop.rds')
...
#include all crimes per 1000 people
#Nah, do this below, works out the same
#crimesByTypeLong <- merge(crimesByTypeLong, allCrimesPerZonePerPop, by='LSOAcode', all.x = T)
...
#Done. save.
write_csv(crimesByTypeLong,'data/Crimes_SouthYorkshire_byLSOA_allColsArePer1000people.csv')
